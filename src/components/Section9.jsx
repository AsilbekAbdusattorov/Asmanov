...
const Section9 = () => {
  return (
    <section className="bg-9bg bg-cover bg-no-repeat">
      <div className="w-full max-w-7xl mx-auto py-5">
        <h2 className="text-7xl text-center pt-16">"Fantastic!"</h2>
        <p className="text-3xl text-center">More Reviews from Fairfax County Patients</p>
        <div className="flex justify-between my-20">
          <div className="w-[584px] bg-white">
            <div className="p-10">
              ...
              <p className="text-black pt-5 pb-10 text-xl">
              ...
              <p className="text-black border-b text-2xl w-[170px] border-black">
                View on Google
              </p>
            </div>
          </div>
